...
export const createProject = async (req, res) => {
    try{
        ...
        // Add memebers to project if they are in the workspace
    ...
    try{
        ...
        if(!workspace.members.some((member)=>member.userId === userId && member.role === "ADMIN")){
            ...
            if(!project){
                ...
                return res.status(403).json({message: "You dont have the permission to update projects in this workspace"});
            }
